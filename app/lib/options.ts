...
export const MOOD_OPTIONS = [
  ...
  { emoji: "🤯", label: "Mind-bending, I want to think after", value: "mind-bending" },
];

export const THEME_OPTIONS = [
  { emoji: "🗡️", label: "Power and ambition", value: "power-and-ambition" },
  { emoji: "🤝", label: "Friendship and loyalty", value: "friendship-and-loyalty" },
  { emoji: "🧠", label: "Psychological games", value: "psychological-games" },
  { emoji: "🌍", label: "World-building and lore", value: "world-building-and-lore" },
  { emoji: "💔", label: "Love and relationships", value: "love-and-relationships" },
  { emoji: "🔍", label: "Mystery and secrets", value: "mystery-and-secrets" },
  { emoji: "🌱", label: "Growth and becoming someone", value: "growth-and-becoming-someone" },
];
...
export const AVOID_OPTIONS = [
  ...
  { emoji: "💪", label: "Overpowered main character", value: "overpowered-main-character" },
